<template>
  <div class="content_wrapper">
    ...
    <CommonText>
      <h1>
        Toutes les <b>réponses</b> aux questions que <b>vous vous posez</b>.
      </h1>
    </CommonText>

    <UAccordion :items="items" :ui="ui">
...
import flowerSVG from '@/assets/svg/fleur.svg'
...
const items = ref([
  ...
  {
    label: 'Comment prendre rendez-vous ?',
    slot: 'rendez-vous',
  }
])
